...
class Settings
  attr_accessor :account_id, :account_token, :account_product_code, :db_name, :db_driver, :web_port, :trade_duration, :trade_back_test, :trade_use_percent, :trade_past_period, :trade_stop_limit_percent, :trade_num_ranking
